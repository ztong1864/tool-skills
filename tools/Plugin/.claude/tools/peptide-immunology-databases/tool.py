"""ToolUniverse-backed research service cluster: 肽类与免疫学专项数据库.

Bundles these ToolUniverse categories into ONE MCP server (see TOOL.md for why one
server, not one per category): "ampsphere", "ampsphere_record", "cancerppd2", "conoserver", "dbaasp", "hemolytik2", "hlaligandatlas", "mhcmotifatlas", "norine", "pepcalc", "peplife2", "peptideatlas", "tumorhope2".
...
_CATEGORIES = ["ampsphere", "ampsphere_record", "cancerppd2", "conoserver", "dbaasp", "hemolytik2", "hlaligandatlas", "mhcmotifatlas", "norine", "pepcalc", "peplife2", "peptideatlas", "tumorhope2"]
_SLUG = "peptide-immunology-databases"
...
# without it, this bundle's ~13 categories' worth of @tool wrapper objects would
