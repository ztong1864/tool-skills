"""ToolUniverse-backed research service cluster: 公共卫生与政府统计数据.

Bundles these ToolUniverse categories into ONE MCP server (see TOOL.md for why one
server, not one per category): "cdc", "cms_open_payments", "datagov", "dhs_program", "disease_sh_ext", "diseasesh", "euhealth", "eurostat", "nhanes", "nih_reporter", "odphp", "who_gho", "worldbank".
...
_CATEGORIES = ["cdc", "cms_open_payments", "datagov", "dhs_program", "disease_sh_ext", "diseasesh", "euhealth", "eurostat", "nhanes", "nih_reporter", "odphp", "who_gho", "worldbank"]
_SLUG = "public-health-government-stats"
